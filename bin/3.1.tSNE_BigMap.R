...
set_name <- "onlysen" #onlysen, sen2in1

file <- file.path("data/1.processed",paste0("Broc2018_",set_name,"_set.csv")) 
print(Sys.time())
...
save(m.list1, file = paste0('results/',set_name,'/tSNE_',args[1],"_",args[2],'.RData'))
