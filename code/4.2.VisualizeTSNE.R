...
write.csv(Cluster_membership,"data/4.InteractionScores_tSNE/tSNE_Clustermembership_ppx706.csv",row.names = F)
...
write.csv(Cluster_membership,"data/4.InteractionScores_tSNE/tSNE_Clustermembership_ppx825.csv",row.names = F)
